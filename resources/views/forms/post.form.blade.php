            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="banner" class="col-md-4 col-form-label text-md-right">{{ __('Upload Foto Banner') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="isiPost" class="col-md-4 col-form-label text-md-right">{{ __('Isi') }}</label>

                            <div class="col-md-6">
                                <input id="isiPost" type="textarea" class="form-control @error('isiPost') is-invalid @enderror" name="isiPost" required autocomplete="isiPost">
