        ...
        <div class="container">
          <ul class="navbar-nav">
            <li class="nav-item active">
                <a href="#" class="nav-link"><i></i><span>Dashboard</span></a>
              </li>
            <li class="nav-item dropdown">
                <a href="#" class="nav-link"><i></i><span>Barang</span></a>
            </li>
            <li class="nav-item dropdown">
                <a href="#" class="nav-link"><i></i><span>Pemesan</span></a>
              </li>
            <li class="nav-item dropdown">
                <a href="#" class="nav-link"><i></i><span>Membership</span></a>
            </li>
          </ul>
        </div>
      </nav>
